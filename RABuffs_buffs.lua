...
RAB_Buffs = {
	...
	barrier = { name = "Ice Barrier", identifiers = { { tooltip = "Ice Barrier", texture = "Spell_Ice_Lament" } }, grouping = "Mage", class = "Mage", invert = true },
	block = { name = "Ice Block", identifiers = { { tooltip = "Ice Block", texture = "Spell_Frost_Frost" } }, grouping = "Mage", class = "Mage", invert = true },
	magearmor = { name = "Mage Armor", identifiers = { { tooltip = "Mage Armor", texture = "Spell_MageArmor" } }, grouping = "Mage", class = "Mage", recast = 5 },
	frostarmor = { name = "Frost Armor", identifiers = { { tooltip = "Frost Armor", texture = "Spell_Frost_FrostArmor02" } }, grouping = "Mage", class = "Mage", recast = 5 },
	...
	innerfire = { name = "Inner Fire", identifiers = { { tooltip = "Inner Fire", texture = "Spell_Holy_InnerFire" } }, grouping = "Priest", class = "Priest", recast = 3 },
	...
	clarity = { name = "Omen of Clarity", identifiers = { { tooltip = "Omen of Clarity", texture = "Spell_Nature_CrystalBall" } }, grouping = "Druid", class = "Druid", recast = 2 },
	druidshift = {
		name = "Shapeshifted",
		identifiers = {
	...
	command = { name = "Seal of Command", identifiers = { { tooltip = "Seal of Command", texture = "Ability_Warrior_InnerRage" } }, grouping = "Paladin", class = "Paladin" },
	...
	demonarmor = { name = "Demon Armor", identifiers = { { tooltip = "Demon Armor", texture = "Spell_Shadow_RagingScream" } }, grouping = "Warlock", class = "Warlock", recast = 5 },
	...
	hawk = { name = "Aspect of the Hawk", identifiers = { { tooltip = "Aspect of the Hawk", texture = "Spell_Nature_RavenForm" } }, grouping = "Hunter", class = "Hunter", recast = 5 },
	cheetah = { name = "Aspect of the Cheetah", identifiers = { { tooltip = "Aspect of the Cheetah", texture = "Ability_Mount_JungleTiger" } }, grouping = "Hunter", class = "Hunter", recast = 5 },
	beast = { name = "Aspect of the Beast", identifiers = { { tooltip = "Aspect of the Beast", texture = "Ability_Mount_PinkTiger" } }, grouping = "Hunter", class = "Hunter", recast = 5 },
	...
	monkey = { name = "Aspect of the Monkey", identifiers = { { tooltip = "Aspect of the Monkey", texture = "Ability_Hunter_AspectOfTheMonkey" } }, grouping = "Hunter", class = "Hunter", recast = 5 },
	...
	mushroomstam = { name = "Magic Mushroom (stam)", identifiers = { { tooltip = "Increased Stamina", texture = "INV_Boots_Plate_03", spellId = 25661 } }, grouping = "Food/Drink", buffFunc = RAB_UseItem, itemId = 51717 },
